...
public class Incident {
    ...
    private ObjectProperty<Timestamp> dateResolution = new SimpleObjectProperty<>(null);
    ...
    public Incident(int id, String description, Timestamp dateSignalement, String localisation) {
        this.id = new SimpleIntegerProperty(id);
        this.description = new SimpleStringProperty(description);
        this.dateSignalement = new SimpleObjectProperty<>(dateSignalement);
        this.localisation = new SimpleStringProperty(localisation);
    ...
    public Incident(int id, String typeIncident, String description, String localisation, String statut,
                    Timestamp dateSignalement, int serviceAffecte, double latitude, double longitude,
                    String image, Timestamp dateResolution) {
        this.id = new SimpleIntegerProperty(id);
        this.typeIncident = new SimpleStringProperty(typeIncident);
        this.description = new SimpleStringProperty(description);
        this.localisation = new SimpleStringProperty(localisation);
        ...
        // Correction ici : Initialiser correctement dateResolution
        this.dateResolution = new SimpleObjectProperty<>(dateResolution);
    }
    ...
    public ObjectProperty<Timestamp> dateResolutionProperty() {
    ...
    public void setDateResolution(Timestamp resolutionTime) {
        if (this.dateResolution == null) {
            this.dateResolution = new SimpleObjectProperty<>();
        }
        this.dateResolution.set(resolutionTime);
    }



    public Timestamp getDateResolution() {
        return dateResolution.get();
