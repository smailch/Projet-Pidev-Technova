...
public class IncidentService {
    ...
    public boolean incidentExiste(Incident incident, int utilisateur_id) {
        ...
        try  {
            PreparedStatement stmt = MyConnection.getInstance().getCnx().prepareStatement(req);
            stmt.setString(1, incident.getTypeIncident());
            stmt.setString(2, incident.getDescription());
            stmt.setString(3, incident.getLocalisation());
    ...
    public boolean affecterServiceParNom(int incidentId, String nomService) {
        ...
        try (PreparedStatement stmt = MyConnection.getInstance().getCnx().prepareStatement(reqService)) {
        ...
        try (PreparedStatement stmt = MyConnection.getInstance().getCnx().prepareStatement(reqUpdate)) {
    ...
    public void modifierIncident(Incident incident) {
        ...
        try (PreparedStatement stmt = MyConnection.getInstance().getCnx().prepareStatement(query)) {            stmt.setString(1, incident.getTypeIncident());
            stmt.setString(2, incident.getDescription());
            stmt.setString(3, incident.getLocalisation());
